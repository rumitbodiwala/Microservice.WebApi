...
//   dispatch({ type: types.UPDATE_DATA_R });
//   return axios
//     .patch(`${process.env.REACT_APP_BASE_API_URL}/order/create`, payload)
//     .then((res) => {
//       dispatch({ type: types.UPDATE_DATA_S });
//     })
//     .catch((err) => {
...
const createOrder = (payload) => (dispatch) => {
  dispatch({ type: types.UPDATE_DATA_R });
  return axios
  .post(`${process.env.REACT_APP_BASE_API_URL}/order/create`, payload)
...
export { getData, updateData, deleteData, createOrder };
